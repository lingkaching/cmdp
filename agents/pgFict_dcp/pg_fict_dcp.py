...
class pg_fict_dcp:
    ...
    def __init__(self, data=None, load_model=False, dirName="", FileName="", load_path="", seed=None):
        ...
        self.myXi = [100] * self.totalZONES
        self.myBeta = [40] * self.totalZONES
    ...
    def logStat(self, i_episode, vio, vioHat, delay, myLambda, loss_meta, loss_1, loss_2, pg_loss_grad_norm):
        self.writer.add_scalar('Total ResVio', vio, i_episode)
        self.writer.add_scalar('Total ResVioHat', vioHat, i_episode)
        ...
        self.writer.add_scalar('mse', loss_2, i_episode)
        self.writer.add_scalar('LambdaEc', vio*myLambda[2], i_episode)
